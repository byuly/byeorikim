        ...
        <div className="pixel-border retro-shadow bg-card p-8 md:p-12 animate-fade-in">
          ...
          <div className="mb-8 flex flex-col items-center">
            ...
            <p className="text-xs md:text-sm text-muted-foreground max-w-md">
              i like backend. i like systems. i like data. maybe a little frontend. i'm with the trends, i can be 10x developer with AI and coffee. i'll say 1.5x developer without it. coolio.
            </p>
          </div>
